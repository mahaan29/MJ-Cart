...
<%
	ResultSet productdisplay_rs = logic.productDisplay("AC","DWHX");
...
<!-- Haier -->				
<%
	ResultSet product_rs1 = logic.productDisplay("AC", "Haier");
...
<!-- Friedrich -->
<%
	ResultSet product_rs2 = logic.productDisplay("AC", "Friedrich");
...
<!-- Dorosin -->
<%
	ResultSet product_rs3 = logic.productDisplay("AC", "Dorosin");
...
<!-- Haier -->
<%
	ResultSet productview_rs1 = logic.productDisplay("AC", "Haier");
...
<!-- Friedrich -->
<%
	ResultSet productview_rs2 = logic.productDisplay("AC", "Friedrich");
...
<!-- Dorosin -->
<%
	ResultSet productview_rs3 = logic.productDisplay("AC", "Dorosin");
