...
<%
	ResultSet productdisplay_rs = logic.productDisplay("Headphone","AudezeLCD");
...
<!-- Focal Stellia -->
<%
	ResultSet product_rs2 = logic.productDisplay("Headphone", "FocalStellia");
...
<!-- Focal Stellia -->
<%
	ResultSet productview_rs2 = logic.productDisplay("Headphone", "FocalStellia");
