...
<%
	ResultSet productlist_rs1 = logic.productDisplay("Headphone", "FocalStellia");
...
%>
				<div style="width: 760px; height: 240px; float: left ; border-bottom:1px solid grey ; margin-bottom:25px">
						...
						<div class="simpleCart_shelfItem" style="width: 560px; height:200px; float: left">
						...
						<strong><h4 style="margin-top:40px"><font color="red" weight="900">$<%=productlist_rs1.getInt("Discounted_Price") %></font></h4></strong>
...
<%
	ResultSet productlist_rs2 = logic.productDisplay("Headphone", "AudioCouncil");
...
%>
				<div style="width: 760px; height: 240px; float: left ; border-bottom:1px solid grey ; margin-bottom:25px">
						...
						<strong><h4 style="margin-top:40px"><font color="red" weight="900">$<%=productlist_rs2.getInt("Discounted_Price") %></font></h4></strong>
...
<%
	ResultSet productlist_rs3 = logic.productDisplay("Headphone", "AudezeLCD");
...
%>
				<div style="width: 760px; height: 240px; float: left ; border-bottom:1px solid grey ; margin-bottom:25px">
						...
						<strong><h4 style="margin-top:40px"><font color="red" weight="900">$<%=productlist_rs3.getInt("Discounted_Price") %></font></h4></strong>
...
<%
	ResultSet productlist_rs4 = logic.productDisplay("Headphone", "HIFIMAN");
...
%>
				<div style="width: 760px; height: 240px; float: left ; border-bottom:1px solid grey ; margin-bottom:25px">
						...
						<strong><h4 style="margin-top:40px"><font color="red" weight="900">$<%=productlist_rs4.getInt("Discounted_Price") %></font></h4></strong>
