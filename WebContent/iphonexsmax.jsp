...
<body> 
	...
	<!-- breadcrumbs -->
<%
	ResultSet productdisplay_rs = logic.productDisplay("Mobile","iPhoneXSMax");
...
<!-- iPhone XR -->
<%
	ResultSet product_rs3 = logic.productDisplay("Mobile", "iPhoneXR");
...
<!-- iPhone XR -->
<%
	ResultSet productview_rs3 = logic.productDisplay("Mobile", "iPhoneXR");
