...
<%
	ResultSet productdisplay_rs = logic.productDisplay("Laptop","MSI");
...
<!-- Acer Predator -->				
<%
	ResultSet product_rs1 = logic.productDisplay("Laptop", "AcerPredator");
...
<!-- MacBookPro -->
<%
	ResultSet product_rs2 = logic.productDisplay("Laptop", "MacBookPro");
...
<!-- MacBook Air -->
<%
	ResultSet product_rs3 = logic.productDisplay("Laptop", "MacBookAir");
...
<!-- Acer Predator -->
<%
	ResultSet productview_rs1 = logic.productDisplay("Laptop", "Acer");
...
<!-- MacBook Pro -->
<%
	ResultSet productview_rs2 = logic.productDisplay("Laptop", "MacBookPro");
...
<!-- MacBook Air -->
<%
	ResultSet productview_rs3 = logic.productDisplay("Laptop", "MacBookAir");
