...
<%
	ResultSet productdisplay_rs = logic.productDisplay("TV","SonyBravia");
	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="<%=productdisplay_rs.getString("Image_2") %>">
							 <div class="thumb-image"> <img src="<%=productdisplay_rs.getString("Image_2") %>" data-imagezoom="true" class="img-responsive img2" alt=""> </div>
						</li>
						<li data-thumb="<%=productdisplay_rs.getString("Image_3") %>">
						   <div class="thumb-image"> <img src="<%=productdisplay_rs.getString("Image_3") %>" data-imagezoom="true" class="img-responsive img2" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<style>
				...
				<div class="simpleCart_shelfItem" style="margin-left: 540px; margin-top: -70px">
...
<!-- Hisense -->				
<%
	ResultSet product_rs1 = logic.productDisplay("TV", "Hisense");
...
<!-- Sharp -->
<%
	ResultSet product_rs2 = logic.productDisplay("TV", "Sharp");
...
<!-- LG -->
<%
	ResultSet product_rs3 = logic.productDisplay("TV", "LG");
...
<!-- Hisense -->
<%
	ResultSet productview_rs1 = logic.productDisplay("TV", "Hisense");
...
<!-- Sharp -->
<%
	ResultSet productview_rs2 = logic.productDisplay("TV", "Sharp");
...
<!-- Sony Bravia -->
<%
	ResultSet productview_rs3 = logic.productDisplay("TV", "LG");
