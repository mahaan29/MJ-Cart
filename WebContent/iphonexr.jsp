...
<body> 
	...
	<!-- breadcrumbs -->
<%
	ResultSet productdisplay_rs = logic.productDisplay("Mobile","iPhoneXR");
	...
	<div class="single">
		<div class="container">
			...
			<style>
				...
				<div class="color-quality">
					<div class="color-quality-left">
						...
						<ul>														
							...
							<li><a href="#" class="<%=productdisplay_rs.getString("Color_2") %>"><span></span></a></li>							
						</ul>
					</div>					
						</div>
						<!--quantity-->
				...
				<div class="occasional" style="margin-left: 540px; margin-top: -250px">
					<span style="font-size:1em; color: #3c43a4; font-family: Glegoo">Size Name : </span><b><%=productdisplay_rs.getString("Size") %></b>					
					<div class="clearfix"> </div>
				</div>				 
				<div class="simpleCart_shelfItem" style="margin-left: 540px; margin-top: -250px">
...
<!-- OnePlus 6T -->				
<%
	ResultSet product_rs1 = logic.productDisplay("Mobile", "OnePlus6T");
...
<!-- Samsung S9 -->
<%
	ResultSet product_rs2 = logic.productDisplay("Mobile", "SamsungS9");
...
%>
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3" style="height: 255px !important">
								<img src="<%=product_rs2.getString("Image_Display") %>" alt=" " class="img-responsive" height="255px"/>
								<img src="<%=product_rs2.getString("Image_Display") %>" alt=" " class="img-responsive" height="255px"/>																															
								<div class="w3_hs_bottom">
									<div class="flex_ecommerce">
...
<!-- iPhone XS Max -->
<%
	ResultSet product_rs3 = logic.productDisplay("Mobile", "iPhoneXSMax");
...
<!-- OnePlus6T -->
<%
	ResultSet productview_rs1 = logic.productDisplay("Mobile", "OnePlus6T");
...
<!-- Samsung S9 -->
<%
	ResultSet productview_rs2 = logic.productDisplay("Mobile", "SamsungS9");
...
<!-- iPhone XS Max -->
<%
	ResultSet productview_rs3 = logic.productDisplay("Mobile", "iPhoneXSMax");
