...
<%
	ResultSet productdisplay_rs = logic.productDisplay("AC","Haier");
...
<!-- Dorosin -->				
<%
	ResultSet product_rs1 = logic.productDisplay("AC", "Dorosin");
...
<!-- DWHX -->
<%
	ResultSet product_rs2 = logic.productDisplay("AC", "DWHX");
...
<!-- Friedrich -->
<%
	ResultSet product_rs3 = logic.productDisplay("AC", "Friedrich");
...
<!-- Dorosin -->
<%
	ResultSet productview_rs1 = logic.productDisplay("AC", "Dorosin");
...
<!-- DWHX -->
<%
	ResultSet productview_rs2 = logic.productDisplay("AC", "DWHX");
...
<!-- Friedrich -->
<%
	ResultSet productview_rs3 = logic.productDisplay("AC", "Friedrich");
