...
<%
	ResultSet productdisplay_rs = logic.productDisplay("Laptop","AcerPredator");
...
<!-- MacBook Air -->				
<%
	ResultSet product_rs1 = logic.productDisplay("Laptop", "MacBookAir");
...
<!-- MSI -->
<%
	ResultSet product_rs2 = logic.productDisplay("Laptop", "MSI");
...
<!-- MacBook Pro -->
<%
	ResultSet product_rs3 = logic.productDisplay("Laptop", "MacBookPro");
...
<!-- MacBook Air -->
<%
	ResultSet productview_rs1 = logic.productDisplay("Laptop", "MacBookAir");
...
<!-- MSI -->
<%
	ResultSet productview_rs2 = logic.productDisplay("Laptop", "MSI");
...
<!-- MacBook Pro -->
<%
	ResultSet productview_rs3 = logic.productDisplay("Laptop", "MacBookPro");
