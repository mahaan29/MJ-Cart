...
<%
	ResultSet productdisplay_rs = logic.productDisplay("TV","Sharp");
...
<!-- LG -->				
<%
	ResultSet product_rs1 = logic.productDisplay("TV", "LG");
...
<!-- Hisense -->
<%
	ResultSet product_rs2 = logic.productDisplay("TV", "Hisense");
...
<!-- LG -->
<%
	ResultSet productview_rs1 = logic.productDisplay("TV", "LG");
...
<!-- Hisense -->
<%
	ResultSet productview_rs2 = logic.productDisplay("TV", "Hisense");
