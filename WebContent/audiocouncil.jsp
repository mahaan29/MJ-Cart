...
<%
	ResultSet productdisplay_rs = logic.productDisplay("Headphone","AudioCouncil");
	...
	<div class="single">
		<div class="container">
			...
			<style>
				...
				<div class="simpleCart_shelfItem" style="margin-left: 540px; margin-top: -50px">
...
<!-- HIFIMAN -->				
<%
	ResultSet product_rs1 = logic.productDisplay("Headphone", "HIFIMAN");
...
<!-- Focal Stellia -->
<%
	ResultSet product_rs3 = logic.productDisplay("Headphone", "FocalStellia");
...
%>
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3" style="height: 255px !important">
								<img src="<%=product_rs3.getString("Image_1") %>" alt=" " class="img-responsive" height="255px"/>
								<img src="<%=product_rs3.getString("Image_1") %>" alt=" " class="img-responsive" height="255px"/>																															
								<div class="w3_hs_bottom">
									<div class="flex_ecommerce">
...
<!-- HIFIMAN -->
<%
	ResultSet productview_rs1 = logic.productDisplay("Headphone", "HIFIMAN");
...
<!-- FocalStellia -->
<%
	ResultSet productview_rs3 = logic.productDisplay("Headphone", "FocalStellia");
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<section>
					<div class="modal-body" >
						<div class="col-md-5 modal_body_left">
							<img src="<%=productview_rs3.getString("Image_1") %>" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
