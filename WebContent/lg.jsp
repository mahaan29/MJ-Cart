...
<%
	ResultSet productdisplay_rs = logic.productDisplay("TV","LG");
	...
	<div class="single">
		<div class="container">
			...
			<style>
				...
				<div class="simpleCart_shelfItem" style="margin-left: 540px; margin-top: -100px">
...
<!-- Sony Bravia -->
<%
	ResultSet product_rs3 = logic.productDisplay("TV", "SonyBravia");
...
<!-- Sony Bravia -->
<%
	ResultSet productview_rs3 = logic.productDisplay("TV", "SonyBravia");
