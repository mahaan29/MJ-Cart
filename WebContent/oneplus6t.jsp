...
<body> 
	...
	<!-- breadcrumbs -->
<%
	ResultSet productdisplay_rs = logic.productDisplay("Mobile","OnePlus6T");
	...
	<div class="single">
		<div class="container">
			...
			<style>
				...
				<div class="occasional" style="margin-left: 540px; margin-top: -200px">
					<span style="font-size:1em; color: #3c43a4; font-family: Glegoo">Size Name : </span><b><%=productdisplay_rs.getString("Size") %></b>					
					<div class="clearfix"> </div>
				</div>				 
				<div class="simpleCart_shelfItem" style="margin-left: 540px; margin-top: -200px">
...
<!-- iPhone XR -->				
<%
	ResultSet product_rs1 = logic.productDisplay("Mobile", "iPhoneXR");
...
<!-- iPhone XR -->
<%
	ResultSet productview_rs1 = logic.productDisplay("Mobile", "iPhoneXR");
