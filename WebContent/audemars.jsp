...
<%
	ResultSet productdisplay_rs = logic.productDisplay("Watch","AudemarsPiguet");
...
<!-- IWC -->				
<%
	ResultSet product_rs1 = logic.productDisplay("Watch", "IWC");
...
<!-- Patek Phillipe -->
<%
	ResultSet product_rs2 = logic.productDisplay("Watch", "PatekPhillipe");
...
<!-- Richard Mille -->
<%
	ResultSet product_rs3 = logic.productDisplay("Watch", "RichardMille");
...
<!-- IWC -->
<%
	ResultSet productview_rs1 = logic.productDisplay("Watch", "IWC");
...
<!-- Patek Phillipe -->
<%
	ResultSet productview_rs2 = logic.productDisplay("Watch", "PatekPhillipe");
...
<!-- Richard Mille -->
<%
	ResultSet productview_rs3 = logic.productDisplay("Watch", "RichardMille");
