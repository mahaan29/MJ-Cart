...
<%
	ResultSet productdisplay_rs = logic.productDisplay("Watch","RichardMille");
	...
	<div class="single">
		<div class="container">
			...
			<style>
				...
				<div class="simpleCart_shelfItem" style="margin-left: 540px; margin-top: -110px">
...
<!-- Audemars Piguet -->				
<%
	ResultSet product_rs1 = logic.productDisplay("Watch", "AudemarsPiguet");
...
<!-- IWC -->
<%
	ResultSet product_rs2 = logic.productDisplay("Watch", "IWC");
...
<!-- Patek Phillipe -->
<%
	ResultSet product_rs3 = logic.productDisplay("Watch", "PatekPhillipe");
...
<!-- Audemars Piguet -->
<%
	ResultSet productview_rs1 = logic.productDisplay("Watch", "AudemarsPiguet");
...
<!-- IWC -->
<%
	ResultSet productview_rs2 = logic.productDisplay("Watch", "IWC");
...
<!-- Patek Phillipe -->
<%
	ResultSet productview_rs3 = logic.productDisplay("Watch", "PatekPhillipe");
