...
<html lang="en">
<head>
<title>Mail Us - The MJ Store</title>
<!-- for-mobile-apps -->
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs" style="width : 80%; margin-left:10%">
					<ul class="nav navbar-nav">
						...
						<li><a href="mail.jsp" class="act">Mail Us</a></li>
					</ul>
				</div>
			</nav>
		</div>
		...
		<div class="container">
			...
			<div class="agile_mail_grids">
				<div class="col-md-5 contact-left">
					<h4>Address</h4>
					<p>AU -1, Grandcity Plaza</p>
						<span>Ludhiana,Punjab</span></p>
						<span>India</span></p>
					<ul>
						<li>Free Phone :+91 87250 73002</li>
						<li>Telephone :+91 87250 73002</li>
						<li>Fax :+1 078 4589 2456</li>
						<li><a href="mailto:jainmahaan@gmail.com">jainmahaan@gmail.com</a></li>
					</ul>
				</div>
			...
			<div class="contact-bottom">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3424.5371494235296!2d75.80857161509448!3d30.871631185976142!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391a8226f1a8f663%3A0x5b58297caa9d8500!2sGrand+City+Plaza+Ludhiana!5e0!3m2!1sen!2sin!4v1555917618033!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
			</div>
		</div>
	</div>
	<!-- //mail -->
			...
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><a href="products_ac.jsp">Special Products</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Category</h3>
